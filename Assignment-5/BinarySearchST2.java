 ...
 * which consists of following methods
 ...
 * Iterable keys() ---- return all keys, in sorted order
 * @author Divya
 */
public class BinarySearchST2<Key extends Comparable<Key>, Value> {
      /**
       * keys is an arrays of all keys.
       */
       private Key[] keys;
       /**
        * vals is an array of values corresponding to keys.
        */
       private Value[] vals;
       /**
        * n is thenumber of keys in the keys array.
        */
       private int n;
       /**
       ...
       private int size;
       /**
        * capacity is the capabality of array to store elements.
        */
       int capacity = 5;
    ...
    public static void main(String[] args) {
        BinarySearchST2<Integer, Integer> b = new BinarySearchST2<Integer, Integer>();
        b.put(0,1);
        b.put(2,3);
        b.put(10,3);
        b.put(1000,7);
